...
Practical Ansible notes and project-oriented automation use cases for cloud and on-premises platforms.
...
- [On-premises automation example](examples/use-cases/on-premises.yml)
- [Beginner Ansible interview code](interview-prep/beginner/README.md)
- [Intermediate Ansible interview code](interview-prep/intermediate/README.md)
- [Advanced Ansible interview code](interview-prep/advanced/README.md)
